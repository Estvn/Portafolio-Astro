...
description: 'Desarrollo de Infraestructura en la nube de Azure para un E-commerce.'
image: 
  url: '/assets/projects/infra-ecommerce.webp'
  alt: Infraestructura Ecommerce
technologies: ["Azure Cloud", "Terraform"]
url: 'project-6'
links:
  github:
    - name: "Repositorio Infraestructura Aplicaciones"
      url: "https://github.com/Estvn/ecommerce-infra-applications"
    - name: "Repositorio Infraestructura Almacenamiento"
      url: "https://github.com/Estvn/ecommerce-infra-storage"
    - name: "Repositorio Infraestructura Analítica"
      url: "https://github.com/Estvn/ecommerce-infra-analytics"
  live: ''
---
...
- BLOB Storage - Almacenamiento de multimedsia
- Azure Cache for Redis - Almacenamiento de datos volátiles

- Azure SQL Database - DW/OLAP
- Azure Data Factory - Orquestador del ETL

# Diseño de la Solución 

![Diagrama Arquitectura](/assets/img/projects/infra-ecommerce/Arquitectura_Nube_Ecommerce.drawio.png)
...
- **BLOB Storage.** Almacenar contenido estático y todos los archivos multimedia del negocio.
...
- **Azure Data Factory y DB SQL OLAP**. Un orquestador para manejar el proceso ETL entre la DB OLTP del negocio y la DB OLAP que guardará los datos listos para realizar análisis estratégico.
...
- Las **UI** toman información de la **base de datos SQL y la BLOB** por medio de una única **API** (se ha decidido dejar una sola API, porque la gestión del negocio requiere de un costo computacional mucho menor que el realizado por los clientes).
...
![Grupo de recursos](/assets/img/projects/infra-ecommerce/20250620120733.png)

![Grupo de recursos 2](/assets/img/projects/infra-ecommerce/20250620120909.png)

Creación de los tres Service Plan y sus respectivas Web Apps:

![Service Plan 1](/assets/img/projects/infra-ecommerce/20250620144536.png)

![Service Plan 2](/assets/img/projects/infra-ecommerce/20250620144813.png)

![Service Plan 3](/assets/img/projects/infra-ecommerce/20250620144929.png)

Creación de los servicios Queue Storage y Azure Functions (Servicios Serverless):

![Queue Storage](/assets/img/projects/infra-ecommerce/20250620212226.png)

![Azure Functions](/assets/img/projects/infra-ecommerce/20250620212324.png)

### Despliegue de los servicios de la infraestructura de almacenamiento

Creación de la DB OLTP

![DB OLTP 1](/assets/img/projects/infra-ecommerce/20250620215008.png)

![DB OLTP 2](/assets/img/projects/infra-ecommerce/20250620215100.png)

Creación del BLOB Storage

![BLOB 1](/assets/img/projects/infra-ecommerce/20250620220716.png)

![BLOB 2](/assets/img/projects/infra-ecommerce/20250620220749.png)

Creación de Azure Redis for Cache:

![Redis 1](/assets/img/projects/infra-ecommerce/20250620223418.png)

![Redis 2](/assets/img/projects/infra-ecommerce/20250620223447.png)

Creación de DB OLAP (Datawarehouse)

![OLAP 1](/assets/img/projects/infra-ecommerce/20250620230219.png)

![OLAP 2](/assets/img/projects/infra-ecommerce/20250620230240.png)

Creación de Azure Data Factory (Orquestador ETL)

![Data Factory 1](/assets/img/projects/infra-ecommerce/20250620231349.png)

![Data Factory 2](/assets/img/projects/infra-ecommerce/20250620231709.png)
...
Al descubrir que se puede optar por compartir recursos (e.g. servicio de base de datos puede ser compartido por la base de datos OLAP y OLTP, servicio de cuentas de almacenamiento puede ser compartido por Queue Storage y Azure Functions), la separación de los repositorios depende de más comunicación sobre los servicios que se crean.
...
- Azure SQL Database - DB OLTP
- BLOB Storage - Almacenamiento de multimedia
- Azure Cache for Redis - Almacenamiento de datos volátiles
...
- Una base de datos OLTP donde se guarda toda la información transaccional del negocio, un servicio llamado Azure Data Factory (orquestador) y una base de datos OLAP que sirve para guardar la información procesada e importante para la toma de decisiones, son las herramientas involucradas para el trabajo realizado por el Datawarehouse. 
- Los procedimientos almacenados que forman parte del ETL están alojados en la base de datos OLAP, el orquestador simplemente se encarga del flujo de trabajo realizado por el ETL.
- El uso de estos elementos para el desarrollo de un DW es una opción excelente y más económica que otras opciones (desarrollo de IA para análisis de negocio), además, se puede identificar con precisión las estadísticas del negocio por medio de la data procesada.
