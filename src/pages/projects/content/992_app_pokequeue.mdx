---
title: 'Proyecto Serverless'
description: 'Desarrollo de API REST con FastAPI, UI Background usando Azure Functions y uso de Docker.'
image: 
  url: '/assets/projects/azure-serverless.jpg'
  alt: Proyecto Serverless
technologies: ["Azure Functions / Serverless", "FastAPI / Python", "Next Js / React", "Docker", "Terraform", "SQL Server"]
url: 'project-8'
links:
  github:
    - name: "Repositorio Serverless del Proyecto"
      url: "https://github.com/Estvn/serverless-pokequeue"
    - name: "Repositorio API del Proyecto"
      url: "https://github.com/Estvn/api-pokequeue"
    - name: "Repositorio Infraestructura del Proyecto"
      url: "https://github.com/Estvn/infraestructura-pokequeue"
    - name: "Repositorio Base de Datos del Proyecto"
      url: "https://github.com/Estvn/db-pokequeue"
    - name: "Repositorio UI del Proyecto"
      url: "https://github.com/Estvn/ui-pokequeue"
  live: ''
---
...
![DiagramaPokeQueue](/assets/img/projects/app-pokequeue/DiagramaPokeQueue.svg)
...
![Botón eliminar](/assets/img/projects/app-pokequeue/20250807205501.png)

![Modal confirmación](/assets/img/projects/app-pokequeue/20250807205549.png)

![Confirmación eliminación](/assets/img/projects/app-pokequeue/20250807205605.png)

El registro 65 se ha eliminado:

![Registro eliminado](/assets/img/projects/app-pokequeue/20250807205642.png)

Lista refrescada:

![Lista actualizada](/assets/img/projects/app-pokequeue/20250807205728.png)
...
![Registro en DB](/assets/img/projects/app-pokequeue/20250807211011.png)

Demostrando registro en el BLOB:

![Registro en blob](/assets/img/projects/app-pokequeue/20250807211031.png)

Enviando petición:

![Petición DELETE](/assets/img/projects/app-pokequeue/20250807210835.png)

Elemento eliminado:

![DB después de eliminar](/assets/img/projects/app-pokequeue/20250807211100.png)

![Blob después de eliminar](/assets/img/projects/app-pokequeue/20250807211118.png)

![Estado después de eliminar](/assets/img/projects/app-pokequeue/20250807211138.png)

La captura anterior no estaba actualizada y solo debían estar el reporte 63 y 64

![Estado final](/assets/img/projects/app-pokequeue/20250807211157.png)
...
![Datos extendidos](/assets/img/projects/app-pokequeue/20250808003850.png)
...
![Campo cantidad](/assets/img/projects/app-pokequeue/20250808111909.png)
...
![Modificación BD](/assets/img/projects/app-pokequeue/20250808114147.png)
...
![Reporte 20 registros](/assets/img/projects/app-pokequeue/20250808114429.png)

En la UI se ha agregado el campo de la cantidad de registros en el reporte:

![Cantidad en UI](/assets/img/projects/app-pokequeue/20250808114504.png)
